...
public val WeUI.Icons.Outlined.Tv: ImageVector
    get() {
        if (_tv != null) {
            return _tv!!
        }
        _tv = Builder(name = "Tv", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.9f,
                ...
                verticalLineToRelative(-0.6f)
                close()
                moveTo(11.665f, 8.896f)
                lineTo(9.81f, 8.896f)
                lineTo(9.81f, 15.0f)
                lineTo(8.716f, 15.0f)
                lineTo(8.716f, 8.896f)
                lineTo(6.558f, 8.896f)
                verticalLineToRelative(-0.942f)
                horizontalLineToRelative(5.958f)
                lineToRelative(1.919f, 5.816f)
                horizontalLineToRelative(0.029f)
                lineToRelative(1.924f, -5.816f)
                horizontalLineToRelative(1.167f)
                lineTo(15.04f, 15.0f)
                horizontalLineToRelative(-1.196f)
                lineToRelative(-2.179f, -6.104f)
                close()
            }
        }
        .build()
